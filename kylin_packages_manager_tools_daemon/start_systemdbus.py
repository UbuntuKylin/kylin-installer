...
from kylin_packages_manager_tools_daemon.apt_dbus_service import PackagesManagerDbusService
import sys
...
if __name__ == '__main__':
    ...
    signal.signal(signal.SIGTERM, lambda : mainloop.quit())
    PackagesManagerDbusService(dbus.SystemBus(), mainloop)
    mainloop.run()
