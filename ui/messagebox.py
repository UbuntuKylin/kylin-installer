...
class MessageBox(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.alert.setStyleSheet("QPushButton{background-image:url('" + UBUNTUKYLIN_RES_PATH + "alert.png');border:0px;padding-bottom:4px;color:white;font-size:16px;border-radius:5px;}")
    ...
    #
    def re_move(self):
        self.alert.setGeometry(480 / 2 - 203 / 2, 350 / 2 - 56 / 2, 203, 56)
